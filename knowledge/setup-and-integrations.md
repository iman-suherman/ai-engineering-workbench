...
| **Local incident chain (CJS)** | `incident:stage:a\|b\|c` + local Docker | **100% pull** — human gives PD id, CJS retrieves | Easy |
| **PD webhook service (paid)** | Always-on Docker + `/hooks/pagerduty` | **100% push** — PD hits endpoint, runs A→B→C | Harder (paid) |
